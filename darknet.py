...
Original file is located at
    https://colab.research.google.com/drive/1C0TgenJumIyy8tAtlD6xQBduzGHC88bx
"""
...
def create_modules(blocks):
  ...
  for index,x in enumerate(blocks[1:]):
    ...
    if(x["type"]=="convolutional"):
      ...
      if activation=="leaky":
        activn=nn.LeakyReLU(0.01,inplace=True)
      ...
      anchors=[(anchors[i],anchors[1+i]) for i in range(0,len(anchors),2)]
  ...
  def __init__(self,cfgfile):
    ...
    def forward(self,x,CUDA):
      ...
      for i,module in enumerate(modules):
        ...
        if module_type=="convulational" or module_type=="upsample":
